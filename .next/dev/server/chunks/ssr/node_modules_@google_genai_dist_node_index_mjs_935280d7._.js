module.exports = [
"[project]/node_modules/@google/genai/dist/node/index.mjs [app-rsc] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$ws$2f$lib$2f$websocket$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__$3c$export__default__as__WebSocket$3e$__ = __turbopack_context__.i("[project]/node_modules/ws/lib/websocket.js [app-rsc] (ecmascript) <export default as WebSocket>");
...
/** Usage metadata about response(s). This data type is not supported in Gemini API. */ class GenerateContentResponseUsageMetadata {
}
...
class NodeAuth {
    constructor(opts){
        ...
        this.googleAuth = new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$google$2d$auth$2d$library$2f$build$2f$src$2f$index$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["GoogleAuth"](vertexAuthOptions);
    }
    ...
    async download(params, apiClient) {
        if (params.downloadPath) {
            ...
            if (response instanceof HttpResponse) {
                ...
                __TURBOPACK__imported__module__$5b$externals$5d2f$node$3a$stream__$5b$external$5d$__$28$node$3a$stream$2c$__cjs$29$__["Readable"].fromWeb(response.responseInternal.body).pipe(writer);
            } else {
                (0, __TURBOPACK__imported__module__$5b$externals$5d2f$fs__$5b$external$5d$__$28$fs$2c$__cjs$29$__["writeFile"])(params.downloadPath, response, {
                    encoding: 'base64'
                }, (error)=>{
                    if (error) {
...
class NodeWebSocket {
    ...
    connect() {
        this.ws = new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$ws$2f$lib$2f$websocket$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__$3c$export__default__as__WebSocket$3e$__["WebSocket"](this.url, {
...
//# sourceMappingURL=node_modules_%40google_genai_dist_node_index_mjs_935280d7._.js.map