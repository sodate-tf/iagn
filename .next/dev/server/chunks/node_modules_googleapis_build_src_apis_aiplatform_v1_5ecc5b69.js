module.exports = [
"[project]/node_modules/googleapis/build/src/apis/aiplatform/v1.js [app-route] (ecmascript)", ((__turbopack_context__, module, exports) => {
"use strict";
...
(function(aiplatform_v1) {
    ...
    class Resource$Projects$Locations$Endpoints {
        ...
        constructor(context){
            ...
            this.deployedModels = new Resource$Projects$Locations$Endpoints$Deployedmodels(this.context);
    ...
    class Resource$Projects$Locations$Endpoints$Deployedmodels {
        ...
        constructor(context){
            this.context = context;
            this.invoke = new Resource$Projects$Locations$Endpoints$Deployedmodels$Invoke(this.context);
        }
    }
    ...
    class Resource$Projects$Locations$Endpoints$Deployedmodels$Invoke {
        ...
        invoke(paramsOrCallback, optionsOrCallback, callback) {
            ...
            const parameters = {
                options: Object.assign({
                    url: (rootUrl + '/v1/{+endpoint}/deployedModels/{deployedModelId}/invoke/{+invokeId}').replace(/([^:]\/)\/+/g, '$1'),
                    method: 'POST',
                    apiVersion: ''
                }, options),
                params,
    ...
    class Resource$Projects$Locations$Ragengineconfig {
        ...
        constructor(context){
            this.context = context;
            this.operations = new Resource$Projects$Locations$Ragengineconfig$Operations(this.context);
        }
    }
...
//# sourceMappingURL=node_modules_googleapis_build_src_apis_aiplatform_v1_5ecc5b69.js.map